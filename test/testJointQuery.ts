...
export function run () {
    ...
    test('show me the total order count group by color of cars',async t => {
    ...
    test('show me the total order count group by color of cars and sex of customer',async t => {
