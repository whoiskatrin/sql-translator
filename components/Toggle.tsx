...
const Toggle: React.FC<Props> = ({ isUppercase, handleSwitchText: switchText }) => {
  return (
    <label className="relative inline-flex items-center mb-5 cursor-pointer">
      ...
      />
      <div className="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 
      ...
      <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Uppercase</span>
    </label>
  )
}
